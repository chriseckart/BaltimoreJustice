//
//  ConfirmYourInfoTableViewController.swift
//  BaltimoreJustice
//
//  Created by Christopher Eckart on 3/5/17.
//  Copyright © 2017 Christopher Eckart. All rights reserved.
//

import UIKit

class ConfirmYourInfoTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellIdentifier = "ConfirmYourInfoTableViewCell"
        
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? ConfirmYourInfoTableViewCell  else {
            fatalError("The dequeued cell is not an instance of ConfirmYourInfoTableViewCell.")
        }
